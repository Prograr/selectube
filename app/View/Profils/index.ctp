...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
				<li><?php echo $this->Html->link(__('New Profil'), array('action' => 'add'), array('class' => '')); ?></li>						<li><?php echo $this->Html->link(__('List Users'), array('controller' => 'users', 'action' => 'index'), array('class' => '')); ?></li> 
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($profil['User']['pseudo'], array('controller' => 'users', 'action' => 'view', $profil['User']['id'])); ?>
		</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $profil['Profil']['id']), array('class' => 'btn btn-mini'), __('Are you sure you want to delete # %s?', $profil['Profil']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
			</table>
