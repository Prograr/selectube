...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Favori.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Favori.id'))); ?></li>
										<li><?php echo $this->Html->link(__('List Favoris'), array('action' => 'index')); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="favoris form">
		
			<?php echo $this->Form->create('Favori', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal')); ?>
				<fieldset>
					<h2><?php echo __('Edit Favori'); ?></h2>
