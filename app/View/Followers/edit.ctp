	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Follower.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Follower.id'))); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="followers form">
			...
			<?php echo $this->Form->create('Follower', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal')); ?>
				<fieldset>
					<h2><?php echo __('Edit Follower'); ?></h2>
